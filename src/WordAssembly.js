  ...
  return (
    <div className='container'>
      ...
      <div className="left">
        ...
        <Quantity inputName="topics" callback={onQuantTopicsChanged} referName="topics" quantName="# of Topics" quantValue={3} marginBottom="40px"></Quantity>
        <Lang inputName="lang" callback={onLangChanged} referName="lang" langValue={lang} marginBottom="60px"></Lang>  
      </div>
